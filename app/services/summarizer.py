...
ייתכן שהתמלול בנוי משורות שכל אחת מתחילה בזיהוי דובר (למשל "Speaker A:" או שם אמיתי). כשמופיעה שאלה על דובר ספציפי, חפש את שורותיו לפי השם שניתן ב"מיפוי דוברים".
ענה בעברית.
"""
...
- ייתכן שבתוכן יש תמלול לפי דוברים: כל שורה מתחילה בזיהוי דובר ("Speaker A:", "Speaker B:" או שם אמיתי).
  כשהמשתמש שואל על דובר ספציפי (למשל "כמה שאלות אסף שאל?", "מה המרצה ענה?"),
  חפש לפי השמות שב"מיפוי דוברים" שלהלן וספור/דווח לפי השורות המתאימות בלבד.
